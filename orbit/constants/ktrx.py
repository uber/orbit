...
class DataInputMapper(Enum):
    ...
    _REGULAR_REGRESSOR_KNOT_INIT_LOC = 'RR_KNOT_INIT_LOC'
    _REGULAR_REGRESSOR_KNOT_INIT_SCALE = 'RR_KNOT_INIT_SCALE'
    _REGULAR_REGRESSOR_KNOT_SCALE = 'RR_KNOT_SCALE'
    _POSITIVE_REGRESSOR_KNOT_INIT_LOC = 'PR_KNOT_INIT_LOC'
    _POSITIVE_REGRESSOR_KNOT_INIT_SCALE = 'PR_KNOT_INIT_SCALE'
...
DEFAULT_COEFFICIENTS_KNOT_INIT_SCALE = 1.0
DEFAULT_COEFFICIENTS_KNOT_INIT_LOC = 0
