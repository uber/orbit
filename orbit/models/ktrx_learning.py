...
from ..constants import ktrx_learning as constants
from ..constants.constants import (
    PredictMethod,
    CoefPriorDictKeys,
)
from ..constants.ktrx_learning import (
...
class BaseKTRX_learning(BaseTemplate):
        ...
        if self._num_of_regressors > 0:
            if self._coefficients_knot_dates is None:
                ...
                self._knots_tp_coefficients = np.array(
                    ...
                    (get_gap_between_dates(start_date, self.training_end, infer_freq) + 1)
                )
    ...
    def _generate_seas(self, df, coef_knot_dates, coef_knot, seasonality, seasonality_fs_order):
        """
        :param df:
        :param coef_knot_dates:
        :param coef_knot:
        :param seasonality:
        :param seasonality_fs_order:
        :return:
        """
    ...
    def get_regression_coefs(self, aggregate_method, include_ci=False, date_array=None, lower=0.05, upper=0.95):
...
class KTRXFull_learning(FullBayesianTemplate, BaseKTRX_learning):
